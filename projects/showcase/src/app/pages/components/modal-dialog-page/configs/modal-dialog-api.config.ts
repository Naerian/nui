...
export const MODAL_DIALOG_API_SECTIONS: ComponentSection[] = [
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['<code>footerTemplate</code>', 'TemplateRef&lt;any&gt;', '-', 'TemplateRef for the footer (lower priority than directive or customButtons)'],
        ...
        ['<code>canBeClosed</code>', 'boolean', 'true', 'If false, hides the close button and blocks all close gestures (use for loaders)'],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['<code>callback</code>', '(modalRef?: ModalDialogRef) =&gt; void | Promise&lt;void&gt;', '-', 'Click handler (required)'],
        ['<code>disabled</code>', 'boolean', 'false', 'Static disabled state (evaluated once at open time)'],
        ['<code>loading</code>', 'boolean', 'false', 'Static loading state (evaluated once at open time)'],
        ['<code>closeOnClick</code>', 'boolean', 'false', 'Auto-close the modal after the callback runs'],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['<code>variant</code>', 'NUIVariant', '-', 'Button variant (solid, outline, ghost)'],
        ['<code>size</code>', 'NUISize', '-', 'Button size'],
        ['<code>handler</code>', '() =&gt; void | Promise&lt;void&gt;', '-', 'Click handler (required)'],
        ['<code>disabled</code>', 'boolean | (() =&gt; boolean)', 'false', 'Static boolean or reactive getter — re-evaluated every CD cycle'],
        ['<code>loading</code>', 'boolean | (() =&gt; boolean)', 'false', 'Static boolean or reactive getter — re-evaluated every CD cycle'],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ['<code>register()</code>', 'actions: ModalDialogAction[]', 'void', 'Registers a set of footer actions, replacing any existing ones'],
        ['<code>add()</code>', 'action: ModalDialogAction', 'void', 'Adds a single action to the existing set'],
        ['<code>update()</code>', 'index: number, partial: Partial&lt;ModalDialogAction&gt;', 'void', 'Updates an action by its index (partial patch)'],
        ['<code>clear()</code>', '-', 'void', 'Removes all registered actions'],
        ['<code>registerFooterTemplate()</code>', 'template: TemplateRef&lt;any&gt; | null', 'void', 'Registers a TemplateRef as full footer (overrides actions; lower priority than directive)'],
      ],
    },
  },
  {
