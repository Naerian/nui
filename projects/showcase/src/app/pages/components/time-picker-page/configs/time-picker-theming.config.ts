...
export const TIME_PICKER_THEMING_SECTIONS: ComponentSection[] = [
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        [
          '<code>--time-picker-item-height</code>',
          'Altura estándar de items',
          '2.25rem',
        ],
        ['<code>--time-picker-padding</code>', 'Padding estándar del picker', '0.75rem'],
        ['<code>--time-picker-max-height</code>', 'Altura máxima del picker', '12rem'],
        ['<code>--time-picker-min-height</code>', 'Altura mínima del picker', '8rem'],
        ['<code>--time-picker-font-size</code>', 'Tamaño de fuente estándar', 'var(--nui-font-size-md)'],
        ['<code>--time-picker-item-radius</code>', 'Radio de borde de items', 'calc(var(--nui-border-radius-md) - 0.125rem)'],
      ],
    },
  },
  {
