...
export const TIME_SELECTOR_I18N_SECTIONS: ComponentSection[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    table: {
      ...
      rows: [
        ['<code>timeSelector.setToCurrentTime</code>', '"Now"', 'components.timeSelector.i18n.tokens.rows.setToCurrentTime.description'],
        ...
        ['<code>timeSelector.normalizedTime</code>', '"Normalized time <br/> ({ original } → { normalized })"', 'components.timeSelector.i18n.tokens.rows.normalizedTime.description'],
        ['<code>timeSelector.rangeLabel</code>', '"Allowed range"', 'components.timeSelector.i18n.tokens.rows.rangeLabel.description'],
        ['<code>timeSelector.timeSelected</code>', '"Time selected"', 'components.timeSelector.i18n.tokens.rows.timeSelected.description'],
      ],
    },
  },
  // ─────────────────────────────────────────────────────────────────────────
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['<code>timeSelector.tabs.presets</code>', '"Shortcuts"', 'components.timeSelector.i18n.durationAndPresets.rows.tabPresets.description'],
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    note: {
      type: 'info',
      content: 'components.timeSelector.i18n.a11yTokens.note',
    },
    table: {
      headers: [
        'common.tables.token',
      ...
      rows: [
        ...
        ['<code>timeSelector.a11y.durationPickerLabel</code>', '"Duration picker"', 'components.timeSelector.i18n.a11yTokens.rows.durationPickerLabel.description'],
        ['<code>timeSelector.a11y.hourColumnHelp</code>', '"Use arrow keys to navigate, Enter to select, Home/End for first/last"', 'components.timeSelector.i18n.a11yTokens.rows.hourColumnHelp.description'],
        ['<code>timeSelector.a11y.minuteColumnHelp</code>', '"Use arrow keys to navigate, Enter to select, Home/End for first/last, Page Up/Page Down to jump 5"', 'components.timeSelector.i18n.a11yTokens.rows.minuteColumnHelp.description'],
        ['<code>timeSelector.a11y.periodHelp</code>', '"Use arrow keys or Tab to navigate, Enter to select"', 'components.timeSelector.i18n.a11yTokens.rows.periodHelp.description'],
        ['<code>timeSelector.a11y.normalizedAlert</code>', '"Time adjusted: { original } was normalized to { normalized }"', 'components.timeSelector.i18n.a11yTokens.rows.normalizedAlert.description'],
        ['<code>timeSelector.a11y.rangeInfo</code>', '"Available time range"', 'components.timeSelector.i18n.a11yTokens.rows.rangeInfo.description'],
      ],
    },
    examples: [
      {
  ...
  providers: [
    provideNuiI18n({
      ...
      },
      {
        ...
        language: 'html',
        code: `<!-- The component reads all i18n values from the global provideNuiI18n provider -->
<nui-time-selector [config]="myConfig" />`,
      },
    ],
  },
];
