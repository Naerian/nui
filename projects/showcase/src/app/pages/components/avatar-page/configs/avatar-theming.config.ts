...
export const AVATAR_THEMING_SECTIONS: ComponentSection[] = [
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        // Bordes y formas
        ['<code>--nui-avatar-border-radius-circular</code>', 'Radio de borde para variante circular', '50%'],
        ['<code>--nui-avatar-border-radius-rounded</code>', 'Radio de borde para variante rounded', 'var(--nui-border-radius-md)'],
        ['<code>--nui-avatar-border-radius-square</code>', 'Radio de borde para variante square', '0'],
        
        // Bordes opcionales
        ['<code>--nui-avatar-border-width</code>', 'Grosor del borde del avatar', '0'],
        ['<code>--nui-avatar-border-color</code>', 'Color del borde del avatar', 'transparent'],
        
        // Colores por defecto
        ['<code>--nui-avatar-bg-default</code>', 'Color de fondo por defecto', 'var(--nui-bg-tertiary)'],
        ['<code>--nui-avatar-text-default</code>', 'Color de texto/icono por defecto', 'var(--nui-text-secondary)'],
        
        // Tipografía
        ['<code>--nui-avatar-font-weight</code>', 'Peso de fuente para iniciales', 'var(--nui-font-weight-semibold)'],
      ],
    },
  },
];
