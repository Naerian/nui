...
Run `ng build nui` to build the project. The build artifacts will be stored in the `dist/` directory.

## Publishing

After building your library with `ng build nui`, go to the dist folder `cd dist/nui` and run `npm publish`.
